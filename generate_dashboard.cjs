    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <button
            onClick={() => setCurrentView("eleves")}
            className="flex items-center gap-3 p-4 rounded-xl bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/40 text-left transition group shadow-md"
          >
            ...
            <div>
              <div className="text-sm font-bold text-blue-100 group-hover:text-white">Inscrire un Élève</div>
              <div className="text-[10px] text-blue-300/70">Nouvelle admission</div>
            </div>
          </button>
          ...
          <button
            onClick={() => setCurrentView("finance")}
            className="flex items-center gap-3 p-4 rounded-xl bg-emerald-600/10 hover:bg-emerald-600/20 border border-emerald-500/30 text-left transition group shadow-md"
          >
            ...
            <div>
              <div className="text-sm font-bold text-emerald-100 group-hover:text-white">Recevoir Paiement</div>
              <div className="text-[10px] text-emerald-300/70">Caisse et minervals</div>
            </div>
          </button>

          {/* Secondary Actions grouped together in a smaller grid or just continue but lighter */}
          <button
            onClick={() => setCurrentView("bulletin")}
            className="flex items-center gap-3 p-4 rounded-xl bg-[#12305A]/40 hover:bg-[#12305A]/60 border border-[#94C5FF]/15 text-left transition group"
          >
            <div className="w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center text-purple-400 group-hover:scale-110 transition-transform shrink-0">
              <FileText className="w-5 h-5" />
            </div>
            <div>
              <div className="text-sm font-bold text-blue-200">Générer Bulletins</div>
              <div className="text-[10px] text-blue-300/60">Fin de période</div>
            </div>
          </button>
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 rounded-xl bg-[#12305A]/40 hover:bg-[#12305A]/60 border border-[#94C5FF]/15 text-left transition group"
          >
            <div className="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform shrink-0">
              <BookOpen className="w-5 h-5" />
            </div>
            <div>
              <div className="text-sm font-bold text-blue-200">Gérer Classes</div>
              <div className="text-[10px] text-blue-300/60">Organisation</div>
            </div>
          </button>
        </div>
      </div>
...
fs.writeFileSync('./src/components/views/DashboardView.jsx', updatedCode, 'utf8');
