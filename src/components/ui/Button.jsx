...
export function Button({
  ...
  const variantStyles = {
    primary:
      "bg-blue-600/90 hover:bg-emerald-400 backdrop-blur-md text-white shadow-sm hover:shadow-md focus:ring-emerald-400 border border-emerald-400/50",
    secondary:
    ...
    outline:
      "bg-transparent hover:bg-[#12305A]/45 backdrop-blur-md text-slate-700  hover:text-white border border-[#94C5FF]/15 focus:ring-blue-400/50",
    ghost:
      "bg-transparent hover:bg-blue-500/10 text-blue-300/70  hover:text-blue-100 border border-transparent focus:ring-slate-700",
    danger:
      "bg-rose-600 hover:bg-rose-500 text-white shadow-md shadow-rose-600/25 focus:ring-rose-500 border border-rose-500/30",
    success:
      "bg-blue-700 hover:bg-blue-600 text-white shadow-md shadow-emerald-600/25 focus:ring-emerald-500 border border-emerald-500/30",
    amber:
      "bg-amber-600 hover:bg-amber-500 text-white shadow-md shadow-amber-600/25 focus:ring-amber-500 border border-amber-500/30",
    white:
      "bg-white hover:bg-slate-100 text-blue-100 shadow-md shadow-black/10 focus:ring-white border border-[#94C5FF]/15 font-semibold",
  };
