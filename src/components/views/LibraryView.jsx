...
export function LibraryView() {
  ...
  const [filterType, setFilterType] =
    useState("all"); /* all, pdf, video, memory */
  const libraryItems = [
    {
      id: 1,
      title: "Mathématiques - 1ère Primaire",
      type: "pdf",
      author: "École d'Excellence",
      size: "2.4 MB",
      price: 0,
      required: true,
    },
    {
      id: 2,
      title: "Histoire du Congo (Manuel)",
      type: "book",
      author: "Isidore Ndaywel",
      price: 15,
      required: false,
    },
    {
    ...
    {
      id: 4,
      title: "Mémoire: L'impact du numérique",
      type: "memory",
      author: "Ancien Élève",
      size: "1.8 MB",
      price: 0,
  ...
  const handleBuy = (item) => {
    if (item.price === 0) {
      ...
      showToast(
        `Demande d'achat pour \${item.title} (\${item.price}$) envoyée à la comptabilité.`,
      );
    }
  };
  return (
