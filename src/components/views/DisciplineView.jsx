      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {data.incidents.map((inc) => {
          ...
          return (
            <div
              key={inc.id}
              className="bg-blue-500/10 rounded-2xl border border-[#94C5FF]/15/60 p-5 space-y-4 flex flex-col justify-between"
            >
              {" "}
              <div className="space-y-3">
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2.5">
                    {" "}
                    <div className="w-10 h-10 rounded-2xl bg-blue-500/20 text-blue-400 flex items-center justify-center font-bold text-xs shrink-0">
                      {" "}
                ...
                <p className="text-xs text-[#F5F9FF] bg-[#12305A]/45 A]/45 bg-[#12305A]/45 backdrop-blur-md/60 backdrop-blur-md/60 p-3 rounded-2xl border border-[#94C5FF]/15">
                  {" "}
                  {inc.description}{" "}
                </p>{" "}
                <div className="text-xs text-blue-300 bg-blue-500/10 p-3 rounded-2xl border border-blue-500/20">
                  {" "}
                  <strong className="block text-[10px] uppercase text-blue-400 mb-0.5">
                    Sanction / Mesure :
                  </strong>{" "}
                  {inc.sanction}{" "}
                </div>{" "}
              </div>{" "}
              <div className="flex items-center justify-between pt-3 border-t border-[#94C5FF]/15 C5FF]/15 text-xs text-[#F5F9FF]0">
                {" "}
                <span>
