...
export function MobileBottomNav({ onOpenMenu }) {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#12305A]/45 backdrop-blur-2xl border-t border-[#94C5FF]/15 pb-safe shadow-[0_-8px_32px_rgba(0,0,0,0.05)] select-none">
      {" "}
        ...
        {accessibleItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center min-h-[50px] min-w-[60px] rounded-2xl transition-all duration-300 z-10 ${isActive ? "text-emerald-600" : "text-[#F5F9FF]0 hover:text-[#F5F9FF]"}`}
