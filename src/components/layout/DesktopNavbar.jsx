...
export function DesktopNavbar() {
  ...
  const getTitle = () => {
    switch (currentView) {
      case "dashboard":
        return "Tableau de Bord & Métriques Clés";
      case "eleves":
        return "Annuaire des Élèves & Inscriptions";
      case "eleve-detail":
        return "Fiche & Dossier Individuel Élève";
      case "enseignants":
        return "Répertoire du Corps Enseignant";
      case "classes":
        return "Structure des Classes & Salles de Cours";
      case "cours":
        return "Programme des Cours & Coefficients";
      case "horaires":
        return "Grille des Emplois du Temps";
      case "presences":
        return "Pointage Quotidien & Taux d’Assiduité";
      case "discipline":
        return "Discipline & Registre des Sanctions";
      case "resultats":
      case "palmares":
        return "Palmarès des Cotes & Notes Périodiques";
      case "bulletin":
        return "Bulletin Scolaire Officiel RDC";
      case "finance":
        return "Trésorerie, Minervals & Caisse Centrale";
      case "recu":
        return "Quittance Officielle de Paiement";
      case "parents":
        return "Espace Parents & Tuteurs";
      case "communication":
        return "Centre de Messagerie & Diffusion d’Alertes";
      case "parametres":
      case "settings":
        return "Configuration de l’Établissement";
      default:
